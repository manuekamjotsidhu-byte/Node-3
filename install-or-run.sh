...
Environment overrides:
  ...
  GAME_PROTOCOL, TRUSTED_PROXY_HOPS, FIREWALL_ENABLED, RUN_USER
USAGE
}
...
run_foreground() {
  require_node
  export HTTP_PORT UDP_PORT GAME_PROTOCOL TRUSTED_PROXY_HOPS FIREWALL_ENABLED NODE_ENV=production
