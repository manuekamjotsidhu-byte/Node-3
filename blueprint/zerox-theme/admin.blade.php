<div id="zerox-theme-admin" class="zerox-theme-admin" aria-labelledby="zerox-theme-title">
  <header class="zerox-theme-admin__hero">
    <div><span class="zerox-theme-admin__eyebrow">Appearance</span><h1 id="zerox-theme-title">ZeroX Theme</h1><p>Customise the panel safely without replacing Blueprint addon components.</p></div>
  ...
  <div class="zerox-theme-admin__layout">
    <form id="zerox-theme-form" class="zerox-theme-panel">
      <h2>Brand & colours</h2>
      <div class="zerox-theme-presets" id="zerox-theme-presets"></div>
      ...
      <label class="zerox-theme-wide">Background image URL <input name="backgroundImage" type="url" placeholder="https://…"></label>
      <div class="zerox-theme-fields">
        <label>Image strength <input name="backgroundOpacity" type="range" min="0" max="0.85" step="0.01"></label>
        <label>Glass blur <input name="blur" type="range" min="0" max="32" step="1"></label>
        <label>Corner radius <input name="radius" type="range" min="0" max="28" step="1"></label>
        <label>Font scale <input name="fontScale" type="range" min="0.85" max="1.2" step="0.05"></label>
      ...
      <div class="zerox-theme-checks"><label><input name="reduceMotion" type="checkbox"> Reduce motion</label><label><input name="highContrast" type="checkbox"> Higher contrast</label></div>
      <div class="zerox-theme-actions"><button type="submit" class="zerox-theme-primary">Save changes</button><button type="button" id="zerox-theme-reset">Reset</button><button type="button" id="zerox-theme-export">Download configuration</button><label class="zerox-theme-import">Import JSON<input id="zerox-theme-import" type="file" accept="application/json"></label></div>
    </form>
