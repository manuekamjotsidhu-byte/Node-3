...
import { createLayer7Guard, createUdpGuardServer } from './index.js';
...
const layer7 = createLayer7Guard({ trustedProxyHops: Number(process.env.TRUSTED_PROXY_HOPS || 0) });
...
const udp = createUdpGuardServer({ bindPort: udpPort, protocol: gameProtocol });
udp.listen();
